...
public class RestartCUAProgramServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println("Remote CUAProg Management : trying to restart CUAPrgram...");
			out.println(CleanUserAccountsProgram.restart(Integer.parseInt(request.getParameter("time"))));
