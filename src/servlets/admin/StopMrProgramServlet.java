...
/**
 * @author AJoan */
public class StopMrProgramServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Set<String> epn= new HashSet<>( //expectedParameterNames
			Arrays.asList(new String[]{}));
	 
	public StopMrProgramServlet() {super();}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println("Remote MRProg Management : trying to stop MRPrgram...");
			out.println(ItemsMRProgram.stop());
