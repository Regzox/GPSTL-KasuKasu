...
public class Evaluation {
	...
	/**
	 * Pr�pare une liste de notifications disponibles � partir des requ�tes 
	 * d'�valuation trouv�es pour l'utilisateur destinataire pass� en param�tre.
	 * 
	 * @param userId
	 * @return
	 */
	...
	/**
	 * Pr�pare une liste de notifications disponibles � partir des responses 
	 * d'�valuation trouv�es pour l'utilisateur destinataire pass� en param�tre.
	 * 
	 * @param userId
	 * @return
	...
	public static JSONObject listResponseNotifications(String userId) {
		...
		try {
			...
			return new Error("Erreur dans la d�ballage de la liste des r�ponses d'�valuation json");
		}
	...
	/**
	 * Construit un objet JSON pour la notification � partir d'informations
	 * 
	 * @param sender
	 * @param image
	 * @param loan
