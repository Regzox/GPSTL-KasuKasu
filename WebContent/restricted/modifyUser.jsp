		...
		<div class="layer-center">
			...
			<form id="modify" class="layer-left" action="javascript:void(0)"
				...
				<fieldset>
					...
					<div class="form-group row">
						<label for="new_email_input" class="col-xs-3 col-form-label">New
							email</label>
						<div class="col-xs-9">
							<input class="form-control" type="email" value=""
								id="new_email_input" name="new_email_input"
								placeholder="Your new email (optional)" maxlength="255">
						</div>
					</div>

					<div class="form-group row">
						<label for="new_password_input" class="col-xs-3 col-form-label">New
							password</label>
						<div class="col-xs-9">
					...
					<div class="form-group row">
						<label for="new_name_input" class="col-xs-3 col-form-label">New
							name</label>
						<div class="col-xs-9">
							<input class="form-control" type="text" value=""
								id="new_name_input" name="new_name_input"
								placeholder="Your new name (optional)" pattern=".{0}|.{1,64}">
						</div>
					</div>

					<div class="form-group row">
						<label for="new_firstname_input" class="col-xs-3 col-form-label">New
							first name</label>
						<div class="col-xs-9">
							<input class="form-control" type="text" value=""
					...
					<div class="form-group row">
						<label for="new_phone_input" class="col-xs-3 col-form-label">New
							phone</label>
						<div class="col-xs-9">
							<input class="form-control" type="text" value=""
								id="new_phone_input" name="new_phone_input"
								placeholder="Your new phone (optional)" pattern="[0][0-9]{9}">
						</div>
					</div>
									...
									<div class="form-group row">
										...
										<div class="col-xs-8">
											<input class="form-control" type="email" value=""
												...
												placeholder="Your current email (obligatory)" required>
										</div>
									</div>

									<div class="form-group row">
										<label for="old_password_input"
											class="col-xs-3 col-form-label">Password *</label>
										<div class="col-xs-8">
											<input class="form-control" type="password" value=""
												id="old_password_input" name="old_password_input"
												placeholder="Your current password (obligatory)" required>
										</div>
									</div>
								</div>
					...
					<button type="button" class="fit-width button" data-toggle="modal"
						data-target="#myModal">Validate</button>
