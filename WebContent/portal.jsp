...
<!-- <title>Welcome to KasuKasu !</title> -->
 <title>Bienvenue sur KasuKasu !</title> 
...
<!-- 		<p>The web site where you can share your items with your friends</p> -->
		...
		<p>Le site où vous pouvez prêter vos objets à vos amis</p>
...
<!-- 		<button type="button" class="btn btn-primary btn-block" onclick="window.location.href = '/KasuKasu/connexion.jsp';">Sign in </button> -->
		...
		<button type="button" class="btn btn-primary btn-block" onclick="window.location.href = '/KasuKasu/createuser.jsp';">Créer votre compte</button>
		<button type="button" class="btn btn-primary btn-block" onclick="window.location.href = '/KasuKasu/connexion.jsp';">Se connecter </button>
	</div>
