...
<title>Conversation with <%=request.getParameter("username")%></title>
...
<body id="gc-search"
	...
	<div class="main-login main-center">
		...
		<h1 align="center" class="title">
			Conversation with @<%=request.getParameter("username")%></h1>
		<br>
		<div id="found-messages" style="max-height: 500px; overflow: auto"
			align="center" class="result_writable_zone"></div>
		<br>
